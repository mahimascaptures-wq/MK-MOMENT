...
const timeline = [
  ...
  {
    year: "Jaipur & Khatu Shyam",
    title: "Our unforgettable little pilgrimage",
    desc: "Our journey started right from the office — we left together for Teen Imli bus stop. It was raining that evening, and somehow the rain made everything feel softer, more special. We boarded the bus to Jaipur and the ride turned into pure fun — chatpate, spicy snacks in our hands, a movie playing inside the bus, laughing at the smallest things. At one of the stops, we had Maggi together — that one bowl made the whole trip feel like a memory worth keeping. The night was quiet, peaceful, and after the movie ended, we slowly drifted off to sleep right there in the bus. Next morning, we reached Singhi Camp, then caught another bus to Khatu Shyam Ji. We freshened up, got ready, and went for darshan. The crowd was massive, but we somehow made our way through — and after coming out, we felt so much like little kids that we said \"chalo ek baar aur darshan karte hain!\" — and went again. Then came the fun part — shopping in the bazaar, sipping fresh juice, soaking in every moment. Later we took the bus back to Jaipur and stayed there for the night. The next morning was all Jaipur — Govind Dev Ji Temple, Hawa Mahal, and many other beautiful places we walked through together. It was truly an unforgettable trip — full of fun, devotion, friendship, and the kind of memories that quietly turn into your favourites.",
  },
